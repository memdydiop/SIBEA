...
<body class="min-h-screen bg-background text-text antialiased selection:bg-accent selection:text-primary-900">
    ...
    <div class="hidden border-b border-white/10 bg-primary-900 text-white/70 lg:block">
        <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-1 text-[0.65rem] sm:px-6 lg:px-8">
            <div class="flex items-center gap-4">
                ...
                <x-whatsapp-link variant="icon" class="size-4! hidden sm:inline-flex" />
            </div>
    ...
    <footer class="relative overflow-hidden bg-primary-900 text-white">
        ...
        <div class="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            {{-- Newsletter bento --}}
            <div class="rounded-2xl bg-white/6 p-6 ring-1 ring-white/10 backdrop-blur sm:p-8 lg:flex lg:items-center lg:justify-between">
                <div>
