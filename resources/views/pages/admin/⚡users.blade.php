            ...
            <table class="w-full text-sm">
                <thead class="bg-zinc-50 dark:bg-zinc-800/50 text-zinc-500">
                    <tr>
                        ...
                        <th class="text-left px-4 py-3">{{ __('Employé lié') }}</th>
                        <th class="text-left px-4 py-3">{{ __('Rôle') }}</th>
                ...
                <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                    @forelse($this->users as $u)
                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/30">
                            ...
                            <td class="px-4 py-3">{{ $u->employee?->full_name ?? '—' }} <span class="text-xs text-zinc-400">{{ $u->employee?->registration_number ?? '' }}</span></td>
                            <td class="px-4 py-3">
                    ...
                    @empty
                        <tr><td colspan="6" class="px-4 py-8 text-center text-zinc-500">{{ __('Aucun utilisateur.') }}</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
