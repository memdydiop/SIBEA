            ...
            <table class="w-full text-sm">
                <thead class="bg-zinc-50 dark:bg-zinc-800/50 text-zinc-500">
                    <tr>
                        ...
                        <th class="text-left px-4 py-3">{{ __('Chef d’équipe') }}</th>
                ...
                <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                    @forelse($this->teams as $team)
                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/30">
                            ...
                            <td class="px-4 py-3"><flux:badge size="sm">{{ $team->code }}</flux:badge></td>
                            <td class="px-4 py-3">{{ $team->department->name }}</td>
                            <td class="px-4 py-3">{{ $team->leader?->full_name ?? '—' }}</td>
                    ...
                    @empty
                        <tr><td colspan="6" class="px-4 py-8 text-center text-zinc-500">{{ __('Aucune équipe.') }}</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
