...
<section class="w-full">
    ...
    @can('create', App\Models\Media::class)
        <form wire:submit="upload" class="mb-8 rounded-lg border border-zinc-200 dark:border-zinc-700 overflow-hidden">
        ...
        @if($this->medias->count() > 0)
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 p-4">
                @foreach($this->medias as $media)
                    <div class="rounded-lg border border-zinc-200 dark:border-zinc-700 overflow-hidden bg-white dark:bg-zinc-900 flex flex-col">
                        <div class="aspect-[16/10] bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center overflow-hidden">
                        ...
                        <div class="p-3 flex-1 flex flex-col gap-1">
                            ...
                            @if($media->alt)
                                <div class="text-xs text-zinc-600 dark:text-zinc-400 line-clamp-2">{{ __('Alt:') }} {{ $media->alt }}</div>
                            @else
    ...
    <div class="mt-6 text-xs text-zinc-500">
        ...
        <a href="{{ route('admin.media') }}" class="underline hover:text-zinc-700 dark:hover:text-zinc-300">{{ __('la médiathèque') }}</a>.
    </div>
</section>
